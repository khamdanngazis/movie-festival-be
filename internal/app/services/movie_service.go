...
type MovieService interface {
	...
	TrackView(ctx context.Context, movieID uint, ipAddress string, userID *uint, WatchDuration int) error
}
...
func (s *MovieServiceImpl) TrackView(ctx context.Context, movieID uint, ipAddress string, userID *uint, WatchDuration int) error {

	err := s.movieRepo.TrackViewership(movieID, ipAddress, userID, WatchDuration)
	if err != nil {
